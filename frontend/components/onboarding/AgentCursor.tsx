...
export function AgentCursor({ stage }: { stage: CursorStage | null }) {
  ...
  return (
    ...
    >
      <div className="relative -translate-x-1/2 -translate-y-1/2">
        <div
          ref={ringRef}
          className="absolute -inset-3 rounded-full border border-dashed border-teal/40"
        />
        <span className="absolute inline-flex h-4 w-4 animate-ping rounded-full bg-teal/50" />
        <span className="relative flex h-4 w-4 rounded-full bg-teal shadow-[0_0_16px_3px_rgba(15,110,104,0.55)]" />
        <div
          ref={labelRef}
